...
class TestLoginUtils(unittest.TestCase):
    ...
    def test_login_user(self):
        with self.app.test_request_context(
            ...
            user = [
                ...
                "aaaaaaaa",
                "aaaaaaaa",
                b"$2b$12$AolQMfJR7M2SmzW8PIpMi.VJFg/R96cWnLXouHEYskkgEjZNHsdqm",
                "student",
            ]
            login_user(
                self.app, user, remember=True, duration=None, force=False, fresh=True
            )
    ...
    def test_login_user_without_remember(self):
        with self.app.test_request_context(
            ...
            login_user(
                self.app, user, remember=False, duration=None, force=False, fresh=True
            )
    ...
    def test_login_user_inactive_user_with_force(self):
        with self.app.test_request_context(
            ...
            login_success = login_user(
                self.app, user, remember=False, duration=None, force=True, fresh=True
            )
    ...
    def test_login_user_with_custom_duration(self):
        with self.app.test_request_context(
            ...
            duration = datetime.timedelta(
                days=7
            )  # Set a custom duration for remember me
            login_user(
                self.app,
                user,
                remember=True,
            ...
            self.assertAlmostEqual(
                session["_remember_seconds"], 604800.0, delta=0.1
            )  # Check for an approximate duration
